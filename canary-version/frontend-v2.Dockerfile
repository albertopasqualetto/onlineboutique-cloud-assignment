...
# distributed underdocker run -d -p 8080:8080 albertopasqualetto/oba-frontend:v2 the License is distributed on an "AS IS" BASIS,
...
# modified from the original to add new v2 endpoint to frontend
